...
export const COURSES: Course[] = [
  {
    ...
    description: 'Master deep learning, LLM fine-tuning, and production ML systems through enterprise-grade capstone projects.',
  ...
  {
    id: 'ui-ux',
    title: 'AI-Powered Product Design (UI/UX)',
    description: 'Design premium interfaces for AI products and dashboards, blending UX research with AI-assisted design workflows.',
  ...
  {
    id: 'video-editing',
    title: 'AI Video Editing & Motion Design',
    description: 'Create cinematic edits, branded reels, and generative motion using Runway, Pika, and Adobe Firefly.',
  ...
  {
    id: 'graphic-design',
    title: 'AI-Powered Graphic Design & Branding',
    description: 'Build scalable brand systems and campaign visuals using Midjourney, Adobe Firefly, and Leonardo AI.',
  ...
  },
  {
    ...
    description: 'Ship production React and Node applications with integrated AI features, APIs, and modern deployment pipelines.',
  ...
  },
  {
    ...
    description: 'Blend performance marketing, SEO, and AI-driven experimentation into one growth playbook.',
...
export type FeaturedCourseCategory =
  ...
  | 'Marketing'
  | 'Prompt Engineering';
export type FeaturedCourseBadge = 'New' | 'Best Seller' | 'Popular' | 'Certificate Included' | 'Live Cohort' | 'Career Track';
...
export const FEATURED_COURSES: FeaturedCourse[] = [
  ...
  },
  {
    ...
    description: 'Design and deploy autonomous agents that plan, reason, and use tools with LangChain and LangGraph.',
  ...
  },
  {
    ...
    description: 'Automate multi-step business processes end to end with n8n, Zapier, Make.com, and AI APIs.',
  ...
  },
  {
    ...
    title: 'Advanced AI Agent Systems & RAG',
    description: 'Go deep on retrieval-augmented generation, vector databases, and multi-agent systems for production.',
  ...
  },
  {
    ...
    description: 'Turn raw data into predictive models and dashboards using Python, SQL, and modern AI tooling.',
  ...
  {
    id: 'cloud-computing-for-ai',
    title: 'Cloud Computing for AI Applications',
    description: 'Deploy, scale, and monitor AI workloads on AWS, Azure, and GCP with production-grade DevOps practices.',
  ...
  },
  {
    ...
    description: 'Use AI-driven threat detection and secure-by-design practices to defend modern applications.',
  ...
  {
    id: 'ai-seo-content-marketing',
    title: 'AI-Powered SEO & Content Marketing',
    description: 'Combine AI writing tools with technical SEO to plan, produce, and scale organic content.',
    image: 'https://images.unsplash.com/photo-1622979135225-d2ba269cf1ac?auto=format&fit=crop&q=80&w=1200',
    instructor: 'Aisha Khan',
    difficulty: 'Beginner',
    category: 'Marketing',
  ...
  {
    id: 'prompt-engineer-career-track',
    title: 'Prompt Engineer Career Accelerator',
    description: 'A mentor-led career track that takes you from prompting fundamentals to a job-ready portfolio.',
